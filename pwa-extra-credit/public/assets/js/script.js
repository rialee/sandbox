...
$(userSpendBtn).on("click", (event) => {
   ...
   $("#perks-results").append(`<tr><th>1</th><td>Amex</td><td>${amexResult[1]}</td><td>${amexResult[1]}</td><td>${amexResult[0]}</td></tr>`);

   // Creates table rows and appends the results of the Citi Card
   $("#perks-results").append(`<tr><th>2</th><td>Citi</td><td>${citiResult[1]}</td><td>${citiResult[1]}</td><td>${citiResult[0]}</td></tr>`);

   // Creates table rows and appends the results of the JetBlue Card
   $("#perks-results").append(`<tr><th>3</th><td>JetBlue</td><td>${jetBlueResult[1]}</td><td>${jetBlueResult[1]}</td><td>${jetBlueResult[0]}</td></tr>`);
